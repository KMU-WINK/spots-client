        ...
        <styled.ProfileContainer>
            ...
            <styled.EnterTimeContainer>
                <styled.weekContainer>
                    {weekList.map((item) => (
                        <styled.weekBtn value={item} key={item} onClick={handleWeek} backColor={(week == item) ? "#FB1E53" : "white"} color={(week == item) ? "white" : "black"}>
                            {item}
                        </styled.weekBtn>
                    ))}
                </styled.weekContainer>
                ...
                <styled.TimeGetContainer>
                    <styled.TimeGetBox>
                        ...
                        <styled.TimeGet marginLeft="20px">
                            <styled.TimeGetTime placeholder="18" onChange={onHourHandler} value={hour} maxLength={2}/>
                                <styled.Colon>
                                    :
                                </styled.Colon>
                            <styled.TimeGetTime placeholder="00" direction="right" onChange={onMinuteHandler} value={minute} maxLength={2} />
            ...
            <styled.Section marginTop="24px">
                <styled.SectionInform>
                    ...
                    <styled.LocationGetBox>
                        <styled.GetInform placeholder="주소를 검색해주세요. (ex. 지번(신대방동), 도로명(신대방길))" width="480px" value={getLocation} onChange={getLocationHandler}/>
                        <styled.SearchBtn>
                            검색
                        </styled.SearchBtn>
                        <styled.ClearBtn>
            ...
            <styled.EditSportsContainer padding="52px 72px 48px">
                ...
                <styled.EtcSports>
                    <styled.EachSports name="etc" onClick={onSelect}><Tennis color={isSelect["etc"] ? "#FB1E53" : null}/></styled.EachSports>
                    <styled.GetInform placeholder="6글자 이내로 기타 종목을 입력해 주세요." width="356px" height="40px" />
                </styled.EtcSports>
