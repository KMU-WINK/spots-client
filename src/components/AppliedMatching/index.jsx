      ...
      {menu === true ? (
        <styled.ClickedMatchingBox>
          <styled.ClickedBox>
            ...
            <styled.UpIcon onClick={clickMenu} />
          </styled.ClickedBox>
          <styled.ClickedBox>
        ...
        <>
          {props.cancel ? (
            <styled.MatchingBox>
              ...
              <styled.MatchingDate opacity="0.4">
                07.08 / 17:00
              </styled.MatchingDate>
              <styled.MatchingPlace opacity="0.4">
                모임 장소
              </styled.MatchingPlace>
              <styled.MatchIcon opacity="0.4" />
              <styled.MatchingNumber opacity="0.4">
                인원 (5/5)
              </styled.MatchingNumber>
              <styled.MatchingStatus opacity="0.4">
                매칭취소
              </styled.MatchingStatus>
              <styled.DownIcon id={id} opacity="0.4" disable={' '} />
            </styled.MatchingBox>
          ) : (
            <styled.MatchingBox>
              <styled.MatchingName>모임 이름</styled.MatchingName>
              ...
              <styled.MatchingNumber>인원 (5/5)</styled.MatchingNumber>
              <styled.MatchingStatus>매칭확정</styled.MatchingStatus>
              <styled.DownIcon onClick={clickMenu} id={id} />
            </styled.MatchingBox>
          )}
        </>
      )}
